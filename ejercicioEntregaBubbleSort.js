...
var dimArreglo = 8;
var arregloAleatorio = new Array(dimArreglo);
...
function intercambiarValores(arreglo, i, j) {
    var auxiliar = 0;
    auxiliar = arreglo[i];
    arreglo[i] = arreglo[j];
    arreglo[j] = auxiliar;
...
function bubbleSort(arreglo) {
    for (var i = 2; i < arreglo.length; i++) { //itero desde el valor 2 porque el primer elemento esta ordenado en la ultima vuelta
...
console.log("de esta manera queda el arreglo ordenado de mayor a menor: ".concat(bubbleSort(arregloAleatorio)));
